...
namespace MR.DotNet.Test
{
    ...
    public class MeshComponentsTests
    {
        ...
        public void TestComponentsMap()
        {
            ...
            var cubeCopy = Mesh.MakeCube(Vector3f.Diagonal(1), Vector3f.Diagonal(-0.5f));
            cube.Transform(new AffineXf3f(Vector3f.Diagonal(2.0f)));
            ...
            Assert.That(map.FaceMap.Count == 24);
            Assert.That(map.FaceMap[0].Id == 0);
            Assert.That(map.FaceMap[12].Id == 1);
        }
        ...
        public void TestLargeRegions()
        {
            ...
            var res = MeshComponents.GetLargeByAreaRegions(mp, map.FaceMap, map.NumComponents, 0.1f);
